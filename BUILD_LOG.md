...
| **4a — Frontend wiring (NEXT)** | Real auth (login/register), org context (replace hardcoded org), mutations (create/publish/delete), live test console (WebRTC→engine) | ⬜ Swarm 2 |
